---
title: "Windows 真实 Steam / galgame 验证"
description: "获授权的逐游戏 Steam 验证、历史失败和后续重测。"
---
...
截至 2026-09-07，已完成一个 Unity galgame 的日常启动验证；当日 9-nine 的四部实际测试及各自的直接启动对照均失败，未增加通过数量。该轮没有证明真实自定义 launcher、干净 Windows 11 安装、更新/卸载及完整原生可访问性矩阵，不能据此宣称达到 [Windows 可用预览门槛](/SteamWrapper/zh-cn/project/design/windows-v2/#8-实施顺序与停止条件)。
